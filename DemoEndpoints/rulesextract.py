...
def extract_single_rule_with_model(text: str, model: str) -> str:
    doc = Path("../methods_doc_concise.md").read_text(encoding="utf-8")
    prompt = (
                    "TASK: Extract compliance requirements from text and convert to AST expressions, fitting to the model.\n"
                    "Format: R{NUMBER}: <expression>\n\n"
                    ...
                    "9. Consider activity label and dataobject labels given in the model.\n\n"
                    " However, if a required label is missing in the model, create an AST anyway.\n\n"
