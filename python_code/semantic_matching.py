...
LABEL_ARGUMENTS = {
    ...
    'parallel': [1, 2],
    'executed_by': [1],
    'executed_by_identify': [1],
    'executed_by_return': [1],
    'recurring': [1],
    'timed_alternative': [1, 2],
    'min_time_between': [1, 2],
    'by_due_date': [1],
    'by_due_date_annotated': [1],
    'by_due_date_explicit': [1],
    'max_time_between': [1, 2],
    'activity_sends': [1],
    'activity_receives': [1],
    'condition_directly_follows': [2],
    'condition_eventually_follows': [2],
    'data_value_alternative_directly_follows': [2],
    'data_value_alternative_eventually_follows': [2],
